Feature: Generic Case KATO
  ...
  Scenario Outline: Determine the CFS and CP for Generic case created manually from start search customer using Start research.
    ...
    Examples: 
      ...
      | mohan.akula@Areteanstech.com | Rules@12345 | Customers |     0000543850 | Generic Case | Order Entry | Additional Order | Default | 1600-MSO Unilever Austria | 20-Sales Transactions | 10-Common Division | Aleksandra Dummy            | Anderson Foister | Pending-Response   | No      | No     |
