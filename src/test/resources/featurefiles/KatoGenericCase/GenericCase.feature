Feature: Generic Case Creation
  ...
  Scenario Outline: Create a Generic case manually from start search customer.
  ...
  And Select status as "<UpdateSatus>"
  ...
  Examples:
  | Username                             | Password    | Value     | CustomerNumber | ServiceCase  | type1            | type2                           | SalesOrg                  | DistChannel           | UpdateSatus        |
