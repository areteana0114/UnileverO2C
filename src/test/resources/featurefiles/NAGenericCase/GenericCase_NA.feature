Feature: Generic Case NA
  ...
  Scenario Outline: Determine the CFS and CP for Generic case created manually from start search customer using Start research.
    ...
    Examples: 
      ...
      | SivaNA.CFS | pEGA@1234 | Customers |     0030004423 | Generic Case | Order Entry | RDD   | RDD Change - Compliance | 0001-    | 10-         | 40-      | abhinash kotikalapudi | Manikumar Kosireddi | Resolved-Completed | Yes     | Yes    |
  ...
  Scenario Outline: Email Outbound for Purpose Of Email is Pending Resonse through Generic case created manually from start search customer using Start research.
    ...
    Examples: 
      ...
      | SivaNA.CFS | pEGA@1234 | Customers |     0030004423 | Generic Case | Order Entry | RDD   | RDD Change - Compliance | 0001-    | 10-         | 40-      | abhinash kotikalapudi | Manikumar Kosireddi | Pending-Response | Pending Response | Customer         |
  ...
  Scenario Outline: Email Outbound for Purpose Of Email is Information Only through Generic case created manually from start search customer using Start research.
    ...
    Examples: 
      ...
      | SivaNA.CFS | pEGA@1234 | Customers |     0030004423 | Generic Case | Order Entry | RDD   | RDD Change - Compliance | 0001-    | 10-         | 40-      | abhinash kotikalapudi | Manikumar Kosireddi | New          | Information Only |
  ...
  Scenario Outline: Generic case Routing to Workbasket using Assign to Workbasket Option.
    ...
    Examples: 
      ...
      | SivaNA.CFS | pEGA@1234 | Customers |     0030004423 | Generic Case | Order Entry | RDD   | RDD Change - Compliance | 0001-    | 10-         | 40-      | Pending-InProgress | Mohan.Akula@Areteanstech.com | Rules@12345 | UnileverO2C:Process control basket |
  ...
  Scenario Outline: Generic case Routing to CFS and Verfy case change log using Assign To CFS option.
    ...
    Examples: 
      ...
      | SivaNA.CFS | pEGA@1234 | Customers |     0030004423 | Generic Case | Order Entry | RDD   | RDD Change - Compliance | 0001-    | 10-         | 40-      | Pending-InProgress | abhinash.kotikalapudi@Areteanstech.com | Pega1234$ | Work status          | Case Responsible          | New                      | Pending-InProgress       | mohan.akula@Areteanstech.com      | abhinash.kotikalapudi@Areteanstech.com |
  ...
  Scenario Outline: Generic case Routing to Workbasket and Verify case change log using Assign to Workbasket Option.
    ...
    Examples: 
      ...
      | SivaNA.CFS | pEGA@1234 | Customers |     0030004423 | Generic Case | Order Entry | RDD   | RDD Change - Compliance | 0001-    | 10-         | 40-      | Pending-InProgress | mohan.akula@Areteanstech.com | Rules@12345 | UnileverO2C:Process control basket | Work status          | Case Responsible          | New                      | Pending-InProgress       | abhinash.kotikalapudi@Areteanstech.com | UnileverO2C:Process control basket |
  ...
  Scenario Outline: Verify the SLA and Expected Resolution Date Time
    ...
    Examples: 
      ...
      | SivaNA.CFS | pEGA@1234 | Customers |     0030004423 | Generic Case | Order Entry | RDD   | RDD Change - Compliance | 0001-    | 10-         | 40-      | Alex Dummy  | Anderson Foister | Pending-InProgress | 2 hrs and 0 mins |
